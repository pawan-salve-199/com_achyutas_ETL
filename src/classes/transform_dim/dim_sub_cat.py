...
class DimSubCat(SparkClass):
    def __init__(self, **kwargs):
        """
        Initialize the DimSubCat class.
        ...
        Parameters:
            ...
            bridge_df (pyspark.sql.DataFrame): DataFrame containing bridge data.
            dataframe (pyspark.sql.DataFrame): DataFrame containing product subcategory data.
        """
